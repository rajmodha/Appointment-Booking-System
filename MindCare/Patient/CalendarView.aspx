<%@ Page Title="Calendar" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CalendarView.aspx.cs" Inherits="Patient_CalendarView" %>
        ...
        <div class="mc-main">
            ...
            <div class="mc-card">
                ...
                <p style="margin-top:12px; font-size:13px; color:var(--mc-muted);">
                    🟢 Days with an appointment are marked below the date number. Click a date to see details.
                </p>
            </div>

            <div class="mc-card">
                <h3 style="margin-top:0; color:var(--mc-primary-dark);">
                    Appointments on <asp:Literal ID="litSelectedDate" runat="server" />
                </h3>
                ...
                <asp:Label ID="lblNoneOnDate" runat="server" Visible="false" Text="No appointments on this date." style="color:var(--mc-muted);" />
            </div>
        </div>
    </div>
</asp:Content>
